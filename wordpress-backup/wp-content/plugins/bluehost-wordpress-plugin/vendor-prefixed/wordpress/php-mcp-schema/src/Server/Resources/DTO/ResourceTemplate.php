...
class ResourceTemplate extends BaseMetadata
{
     ...
     */
    public function __construct(string $name, string $uriTemplate, ?string $title = null, ?string $description = null, ?string $mimeType = null, ?Annotations $annotations = null, ?array $_meta = null, ?array $icons = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(self::asString($data['name']), self::asString($data['uriTemplate']), self::asStringOrNull($data['title'] ?? null), self::asStringOrNull($data['description'] ?? null), self::asStringOrNull($data['mimeType'] ?? null), $annotations, self::asArrayOrNull($data['_meta'] ?? null), $icons);
    }
    /**
