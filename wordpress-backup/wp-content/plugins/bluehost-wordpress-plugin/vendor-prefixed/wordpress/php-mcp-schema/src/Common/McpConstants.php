...
namespace Bluehost\Plugin\WP\McpSchema\Common;
...
final class McpConstants
{
    ...
    {
        return [self::PARSE_ERROR, self::INVALID_REQUEST, self::METHOD_NOT_FOUND, self::INVALID_PARAMS, self::INTERNAL_ERROR, self::URL_ELICITATION_REQUIRED];
    }
    /**
    ...
    {
        return ['PARSE_ERROR' => self::PARSE_ERROR, 'INVALID_REQUEST' => self::INVALID_REQUEST, 'METHOD_NOT_FOUND' => self::METHOD_NOT_FOUND, 'INVALID_PARAMS' => self::INVALID_PARAMS, 'INTERNAL_ERROR' => self::INTERNAL_ERROR, 'URL_ELICITATION_REQUIRED' => self::URL_ELICITATION_REQUIRED];
    }
    /**
    ...
    {
        return in_array($code, self::getErrorCodes(), \true);
    }
    /**
