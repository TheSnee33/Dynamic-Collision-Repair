...
class LegacyTitledEnumSchema extends AbstractDataTransferObject implements EnumSchemaInterface
{
     ...
     */
    public function __construct(array $enum, ?string $title = null, ?string $description = null, ?array $enumNames = null, ?string $default = null)
    {
        $this->type = self::TYPE;
        $this->enum = $enum;
        $this->title = $title;
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(self::asStringArray($data['enum']), self::asStringOrNull($data['title'] ?? null), self::asStringOrNull($data['description'] ?? null), self::asStringArrayOrNull($data['enumNames'] ?? null), self::asStringOrNull($data['default'] ?? null));
    }
    /**
