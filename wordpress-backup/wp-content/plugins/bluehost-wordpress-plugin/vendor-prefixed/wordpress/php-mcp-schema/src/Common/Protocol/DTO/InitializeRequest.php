...
class InitializeRequest extends JSONRPCRequest implements ClientRequestInterface
{
     ...
     */
    public function __construct(string $jsonrpc, $id, InitializeRequestParams $params)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $params = is_array($data['params']) ? InitializeRequestParams::fromArray(self::asArray($data['params'])) : $data['params'];
