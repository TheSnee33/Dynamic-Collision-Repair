...
use Bluehost\Plugin\WP\McpSchema\Common\Protocol\Union\ServerRequestInterface;
use Bluehost\Plugin\WP\McpSchema\Common\Protocol\DTO\PingRequest;
use Bluehost\Plugin\WP\McpSchema\Client\Sampling\DTO\CreateMessageRequest;
use Bluehost\Plugin\WP\McpSchema\Client\Roots\DTO\ListRootsRequest;
use Bluehost\Plugin\WP\McpSchema\Client\Elicitation\DTO\ElicitRequest;
...
final class ServerRequestFactory
{
     ...
     */
    public const REGISTRY = ['ping' => PingRequest::class, 'sampling/createMessage' => CreateMessageRequest::class, 'roots/list' => ListRootsRequest::class, 'elicitation/create' => ElicitRequest::class, 'tasks/get' => GetTaskRequest::class, 'tasks/result' => GetTaskPayloadRequest::class, 'tasks/list' => ListTasksRequest::class, 'tasks/cancel' => CancelTaskRequest::class];
    /**
