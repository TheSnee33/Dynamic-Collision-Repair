...
class CompleteRequestParams extends RequestParams
{
     ...
     */
    public function __construct($ref, CompleteRequestParamsArgument $argument, ?RequestParamsMeta $_meta = null, ?CompleteRequestParamsContext $context = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $argument = is_array($data['argument']) ? CompleteRequestParamsArgument::fromArray(self::asArray($data['argument'])) : $data['argument'];
        ...
        $context = isset($data['context']) ? is_array($data['context']) ? CompleteRequestParamsContext::fromArray(self::asArray($data['context'])) : $data['context'] : null;
        return new self($ref, $argument, $_meta, $context);
    }
    /**
