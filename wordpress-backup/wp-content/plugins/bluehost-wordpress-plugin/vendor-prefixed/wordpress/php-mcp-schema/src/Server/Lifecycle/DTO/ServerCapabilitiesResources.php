...
class ServerCapabilitiesResources extends AbstractDataTransferObject
{
     ...
     */
    public function __construct(?bool $subscribe = null, ?bool $listChanged = null)
    {
    ...
    {
        return new self(self::asBoolOrNull($data['subscribe'] ?? null), self::asBoolOrNull($data['listChanged'] ?? null));
    }
    /**
