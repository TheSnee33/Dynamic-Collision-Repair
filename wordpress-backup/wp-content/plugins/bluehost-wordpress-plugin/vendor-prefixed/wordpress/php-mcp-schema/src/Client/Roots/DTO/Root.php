...
class Root extends AbstractDataTransferObject
{
     ...
     */
    public function __construct(string $uri, ?string $name = null, ?array $_meta = null)
    {
        $this->uri = $uri;
        $this->name = $name;
        $this->_meta = $_meta;
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(self::asString($data['uri']), self::asStringOrNull($data['name'] ?? null), self::asArrayOrNull($data['_meta'] ?? null));
    }
    /**
