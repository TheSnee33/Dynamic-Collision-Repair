...
class GetPromptRequestParams extends RequestParams
{
     ...
     */
    public function __construct(string $name, ?RequestParamsMeta $_meta = null, ?array $arguments = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(self::asString($data['name']), $_meta, self::asStringMapOrNull($data['arguments'] ?? null));
    }
    /**
