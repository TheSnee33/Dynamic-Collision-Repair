...
namespace Bluehost\Plugin\WP\McpSchema\Server\Logging\DTO;
...
class LoggingMessageNotification extends JSONRPCNotification implements ServerNotificationInterface
{
     ...
     */
    public function __construct(string $jsonrpc, LoggingMessageNotificationParams $params)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $params = is_array($data['params']) ? LoggingMessageNotificationParams::fromArray(self::asArray($data['params'])) : $data['params'];
