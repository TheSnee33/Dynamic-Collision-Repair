...
use Bluehost\Plugin\WP\McpSchema\Common\Protocol\Union\ClientNotificationInterface;
...
use Bluehost\Plugin\WP\McpSchema\Common\Protocol\DTO\InitializedNotification;
use Bluehost\Plugin\WP\McpSchema\Client\Roots\DTO\RootsListChangedNotification;
...
final class ClientNotificationFactory
{
     ...
     */
    public const REGISTRY = ['notifications/cancelled' => CancelledNotification::class, 'notifications/progress' => ProgressNotification::class, 'notifications/initialized' => InitializedNotification::class, 'notifications/roots/list_changed' => RootsListChangedNotification::class, 'notifications/tasks/status' => TaskStatusNotification::class];
    /**
