...
class Annotations extends AbstractDataTransferObject
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $audience = isset($data['audience']) ? self::asStringArrayOrNull($data['audience']) : null;
        return new self($audience, self::asFloatOrNull($data['priority'] ?? null), self::asStringOrNull($data['lastModified'] ?? null));
    }
    /**
