...
use Bluehost\Plugin\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface;
...
class ResourceLink extends Resource implements ContentBlockInterface
{
     ...
     */
    public function __construct(string $uri, string $name, ?string $description = null, ?string $mimeType = null, ?Annotations $annotations = null, ?int $size = null, ?array $_meta = null, ?string $title = null, ?array $icons = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $annotations = isset($data['annotations']) ? is_array($data['annotations']) ? Annotations::fromArray(self::asArray($data['annotations'])) : $data['annotations'] : null;
        ...
        return new self(self::asString($data['uri']), self::asString($data['name']), self::asStringOrNull($data['description'] ?? null), self::asStringOrNull($data['mimeType'] ?? null), $annotations, self::asIntOrNull($data['size'] ?? null), self::asArrayOrNull($data['_meta'] ?? null), self::asStringOrNull($data['title'] ?? null), $icons);
    }
    /**
