...
class ResourceContents extends AbstractDataTransferObject
{
     ...
     */
    public function __construct(string $uri, ?string $mimeType = null, ?array $_meta = null)
    {
        $this->uri = $uri;
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(self::asString($data['uri']), self::asStringOrNull($data['mimeType'] ?? null), self::asArrayOrNull($data['_meta'] ?? null));
    }
    /**
