...
class ElicitationCompleteNotification extends JSONRPCNotification implements ServerNotificationInterface
{
     ...
     */
    public function __construct(string $jsonrpc, ElicitationCompleteNotificationParams $params)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $params = is_array($data['params']) ? ElicitationCompleteNotificationParams::fromArray(self::asArray($data['params'])) : $data['params'];
