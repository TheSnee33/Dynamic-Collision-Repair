...
class CompleteResult extends Result implements ServerResultInterface
{
     ...
     */
    public function __construct(CompleteResultCompletion $completion, ?array $_meta = null, ?array $additionalProperties = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $completion = is_array($data['completion']) ? CompleteResultCompletion::fromArray(self::asArray($data['completion'])) : $data['completion'];
        return new self($completion, self::asArrayOrNull($data['_meta'] ?? null), self::additionalFields($data, self::KNOWN_KEYS));
    }
    /**
