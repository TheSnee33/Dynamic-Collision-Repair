...
class CreateTaskResult extends Result
{
     ...
     */
    public function __construct(Task $task, ?array $_meta = null, ?array $additionalProperties = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $task = is_array($data['task']) ? Task::fromArray(self::asArray($data['task'])) : $data['task'];
        return new self($task, self::asArrayOrNull($data['_meta'] ?? null), self::additionalFields($data, self::KNOWN_KEYS));
    }
    /**
