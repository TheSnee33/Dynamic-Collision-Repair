...
namespace Bluehost\Plugin\WP\McpSchema\Common\Core\DTO;
...
class Icon extends AbstractDataTransferObject
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $theme = isset($data['theme']) ? self::asStringOrNull($data['theme']) : null;
        return new self(self::asString($data['src']), self::asStringOrNull($data['mimeType'] ?? null), self::asStringArrayOrNull($data['sizes'] ?? null), $theme);
    }
    /**
