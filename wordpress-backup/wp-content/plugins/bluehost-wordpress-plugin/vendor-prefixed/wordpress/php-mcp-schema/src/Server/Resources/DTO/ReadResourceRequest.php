...
class ReadResourceRequest extends JSONRPCRequest implements ClientRequestInterface
{
     ...
     */
    public function __construct(string $jsonrpc, $id, ReadResourceRequestParams $params)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $params = is_array($data['params']) ? ReadResourceRequestParams::fromArray(self::asArray($data['params'])) : $data['params'];
