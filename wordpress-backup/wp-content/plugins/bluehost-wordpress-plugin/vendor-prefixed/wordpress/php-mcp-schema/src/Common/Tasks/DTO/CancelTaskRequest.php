...
class CancelTaskRequest extends JSONRPCRequest implements ClientRequestInterface, ServerRequestInterface
{
     ...
     */
    public function __construct(string $jsonrpc, $id, CancelTaskRequestParams $params)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $params = is_array($data['params']) ? CancelTaskRequestParams::fromArray(self::asArray($data['params'])) : $data['params'];
