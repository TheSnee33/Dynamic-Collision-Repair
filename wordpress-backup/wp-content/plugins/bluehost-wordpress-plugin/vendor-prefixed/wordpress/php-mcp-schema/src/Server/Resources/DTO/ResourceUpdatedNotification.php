...
class ResourceUpdatedNotification extends JSONRPCNotification implements ServerNotificationInterface
{
     ...
     */
    public function __construct(string $jsonrpc, ResourceUpdatedNotificationParams $params)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $params = is_array($data['params']) ? ResourceUpdatedNotificationParams::fromArray(self::asArray($data['params'])) : $data['params'];
