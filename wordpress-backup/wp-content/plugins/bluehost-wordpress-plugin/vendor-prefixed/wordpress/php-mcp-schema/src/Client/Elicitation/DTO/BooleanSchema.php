...
class BooleanSchema extends AbstractDataTransferObject implements PrimitiveSchemaDefinitionInterface
{
     ...
     */
    public function __construct(?string $title = null, ?string $description = null, ?bool $default = null)
    {
        $this->type = self::TYPE;
        $this->title = $title;
    ...
    {
        return new self(self::asStringOrNull($data['title'] ?? null), self::asStringOrNull($data['description'] ?? null), self::asBoolOrNull($data['default'] ?? null));
    }
    /**
