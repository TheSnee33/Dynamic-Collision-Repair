...
class CallToolResult extends Result implements ServerResultInterface
{
     ...
     */
    public function __construct(array $content, ?array $_meta = null, ?array $structuredContent = null, ?bool $isError = null, ?array $additionalProperties = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self($content, self::asArrayOrNull($data['_meta'] ?? null), self::asArrayOrNull($data['structuredContent'] ?? null), self::asBoolOrNull($data['isError'] ?? null), self::additionalFields($data, self::KNOWN_KEYS));
    }
    /**
