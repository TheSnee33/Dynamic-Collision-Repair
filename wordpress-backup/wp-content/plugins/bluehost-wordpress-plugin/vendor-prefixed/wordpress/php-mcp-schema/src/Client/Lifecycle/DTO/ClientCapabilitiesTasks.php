...
class ClientCapabilitiesTasks extends AbstractDataTransferObject
{
     ...
     */
    public function __construct(?object $list = null, ?object $cancel = null)
    {
        $this->list = $list;
        $this->cancel = $cancel;
    }
    ...
    {
        return new self(self::asObjectOrNull($data['list'] ?? null), self::asObjectOrNull($data['cancel'] ?? null));
    }
    /**
