...
class CancelledNotification extends JSONRPCNotification implements ClientNotificationInterface, ServerNotificationInterface
{
     ...
     */
    public function __construct(string $jsonrpc, CancelledNotificationParams $params)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $params = is_array($data['params']) ? CancelledNotificationParams::fromArray(self::asArray($data['params'])) : $data['params'];
