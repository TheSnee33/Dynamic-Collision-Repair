...
namespace Bluehost\Plugin\WP\McpSchema\Server\Logging\Enum;

use Bluehost\Plugin\WP\McpSchema\Common\AbstractEnum;
/**
...
final class LoggingLevel extends AbstractEnum
{
    ...
    {
        return [self::DEBUG, self::INFO, self::NOTICE, self::WARNING, self::ERROR, self::CRITICAL, self::ALERT, self::EMERGENCY];
    }
}
