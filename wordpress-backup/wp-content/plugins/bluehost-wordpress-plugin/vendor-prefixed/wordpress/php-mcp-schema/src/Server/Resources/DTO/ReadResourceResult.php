...
class ReadResourceResult extends Result implements ServerResultInterface
{
     ...
     */
    public function __construct(array $contents, ?array $_meta = null, ?array $additionalProperties = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self($contents, self::asArrayOrNull($data['_meta'] ?? null), self::additionalFields($data, self::KNOWN_KEYS));
    }
    /**
