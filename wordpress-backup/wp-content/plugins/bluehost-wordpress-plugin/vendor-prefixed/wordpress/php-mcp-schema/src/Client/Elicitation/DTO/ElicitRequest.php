...
use Bluehost\Plugin\WP\McpSchema\Client\Elicitation\Factory\ElicitRequestParamsFactory;
...
class ElicitRequest extends JSONRPCRequest implements ServerRequestInterface
{
     ...
     */
    public function __construct(string $jsonrpc, $id, ElicitRequestParamsInterface $params)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $params = is_array($data['params']) ? ElicitRequestParamsFactory::fromArray(self::asArray($data['params'])) : $data['params'];
        return new self($jsonrpc, $id, $params);
    }
    /**
