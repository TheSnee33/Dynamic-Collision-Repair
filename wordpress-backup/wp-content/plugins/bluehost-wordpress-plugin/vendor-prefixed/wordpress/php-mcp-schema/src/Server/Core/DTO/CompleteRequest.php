...
class CompleteRequest extends JSONRPCRequest implements ClientRequestInterface
{
     ...
     */
    public function __construct(string $jsonrpc, $id, CompleteRequestParams $params)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $params = is_array($data['params']) ? CompleteRequestParams::fromArray(self::asArray($data['params'])) : $data['params'];
