...
class TextContent extends AbstractDataTransferObject implements SamplingMessageContentBlockInterface, ContentBlockInterface
{
     ...
     */
    public function __construct(string $text, ?Annotations $annotations = null, ?array $_meta = null)
    {
        $this->type = self::TYPE;
        $this->text = $text;
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(self::asString($data['text']), $annotations, self::asArrayOrNull($data['_meta'] ?? null));
    }
    /**
