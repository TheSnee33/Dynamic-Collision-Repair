...
namespace Bluehost\Plugin\WP\McpSchema\Common\Lifecycle\DTO;
...
class Implementation extends BaseMetadata
{
     ...
     */
    public function __construct(string $name, string $version, ?string $title = null, ?string $description = null, ?string $websiteUrl = null, ?array $icons = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(self::asString($data['name']), self::asString($data['version']), self::asStringOrNull($data['title'] ?? null), self::asStringOrNull($data['description'] ?? null), self::asStringOrNull($data['websiteUrl'] ?? null), $icons);
    }
    /**
