...
use Bluehost\Plugin\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCNotification;
use Bluehost\Plugin\WP\McpSchema\Common\JsonRpc\DTO\NotificationParams;
...
class InitializedNotification extends JSONRPCNotification implements ClientNotificationInterface
{
     ...
     */
    public function __construct(string $jsonrpc, ?NotificationParams $params = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $params = isset($data['params']) ? is_array($data['params']) ? NotificationParams::fromArray(self::asArray($data['params'])) : $data['params'] : null;
        return new self($jsonrpc, $params);
    }
    /**
