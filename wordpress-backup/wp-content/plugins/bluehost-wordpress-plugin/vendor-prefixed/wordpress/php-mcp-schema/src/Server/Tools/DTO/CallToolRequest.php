...
class CallToolRequest extends JSONRPCRequest implements ClientRequestInterface
{
     ...
     */
    public function __construct(string $jsonrpc, $id, CallToolRequestParams $params)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $params = is_array($data['params']) ? CallToolRequestParams::fromArray(self::asArray($data['params'])) : $data['params'];
