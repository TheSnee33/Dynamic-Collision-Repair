...
class EmbeddedResource extends AbstractDataTransferObject implements ContentBlockInterface
{
     ...
     */
    public function __construct($resource, ?Annotations $annotations = null, ?array $_meta = null)
    {
        $this->type = self::TYPE;
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self($resource, $annotations, self::asArrayOrNull($data['_meta'] ?? null));
    }
    /**
