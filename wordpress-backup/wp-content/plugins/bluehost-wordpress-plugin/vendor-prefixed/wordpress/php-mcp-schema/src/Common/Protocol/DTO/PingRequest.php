...
class PingRequest extends JSONRPCRequest implements ClientRequestInterface, ServerRequestInterface
{
     ...
     */
    public function __construct(string $jsonrpc, $id, ?RequestParams $params = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $params = isset($data['params']) ? is_array($data['params']) ? RequestParams::fromArray(self::asArray($data['params'])) : $data['params'] : null;
