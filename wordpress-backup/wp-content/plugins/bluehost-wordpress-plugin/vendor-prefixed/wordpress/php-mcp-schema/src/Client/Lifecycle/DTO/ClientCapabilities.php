...
namespace Bluehost\Plugin\WP\McpSchema\Client\Lifecycle\DTO;
...
class ClientCapabilities extends AbstractDataTransferObject
{
     ...
     */
    public function __construct(?array $experimental = null, ?ClientCapabilitiesRoots $roots = null, ?ClientCapabilitiesSampling $sampling = null, ?ClientCapabilitiesElicitation $elicitation = null, ?ClientCapabilitiesTasks $tasks = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $roots = isset($data['roots']) ? is_array($data['roots']) ? ClientCapabilitiesRoots::fromArray(self::asArray($data['roots'])) : $data['roots'] : null;
        /** @var \WP\McpSchema\Client\Lifecycle\DTO\ClientCapabilitiesSampling|null $sampling */
        $sampling = isset($data['sampling']) ? is_array($data['sampling']) ? ClientCapabilitiesSampling::fromArray(self::asArray($data['sampling'])) : $data['sampling'] : null;
        /** @var \WP\McpSchema\Client\Lifecycle\DTO\ClientCapabilitiesElicitation|null $elicitation */
        $elicitation = isset($data['elicitation']) ? is_array($data['elicitation']) ? ClientCapabilitiesElicitation::fromArray(self::asArray($data['elicitation'])) : $data['elicitation'] : null;
        /** @var \WP\McpSchema\Client\Lifecycle\DTO\ClientCapabilitiesTasks|null $tasks */
        $tasks = isset($data['tasks']) ? is_array($data['tasks']) ? ClientCapabilitiesTasks::fromArray(self::asArray($data['tasks'])) : $data['tasks'] : null;
        return new self(self::asObjectMapOrNull($data['experimental'] ?? null), $roots, $sampling, $elicitation, $tasks);
    }
    /**
