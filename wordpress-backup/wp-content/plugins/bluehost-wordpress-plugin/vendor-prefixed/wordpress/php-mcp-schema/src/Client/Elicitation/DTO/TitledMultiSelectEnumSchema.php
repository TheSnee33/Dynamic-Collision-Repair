...
class TitledMultiSelectEnumSchema extends AbstractDataTransferObject implements MultiSelectEnumSchemaInterface
{
     ...
     */
    public function __construct(TitledMultiSelectEnumSchemaItems $items, ?string $title = null, ?string $description = null, ?int $minItems = null, ?int $maxItems = null, ?array $default = null)
    {
        $this->type = self::TYPE;
        $this->items = $items;
        $this->title = $title;
    ...
    public static function fromArray(array $data): self
    {
        ...
        $items = is_array($data['items']) ? TitledMultiSelectEnumSchemaItems::fromArray(self::asArray($data['items'])) : $data['items'];
