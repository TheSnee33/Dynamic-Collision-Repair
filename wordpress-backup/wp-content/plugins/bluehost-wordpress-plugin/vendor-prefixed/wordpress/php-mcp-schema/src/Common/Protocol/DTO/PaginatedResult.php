...
class PaginatedResult extends Result
{
     ...
     */
    public function __construct(?array $_meta = null, ?string $nextCursor = null, ?array $additionalProperties = null)
    {
    ...
    {
        return new self(self::asArrayOrNull($data['_meta'] ?? null), self::asStringOrNull($data['nextCursor'] ?? null), self::additionalFields($data, self::KNOWN_KEYS));
    }
    /**
