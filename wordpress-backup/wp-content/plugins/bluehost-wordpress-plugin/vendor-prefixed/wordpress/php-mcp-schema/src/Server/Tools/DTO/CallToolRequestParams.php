...
class CallToolRequestParams extends TaskAugmentedRequestParams
{
     ...
     */
    public function __construct(string $name, ?TaskMetadata $task = null, ?RequestParamsMeta $_meta = null, ?array $arguments = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(self::asString($data['name']), $task, $_meta, self::asArrayOrNull($data['arguments'] ?? null));
    }
    /**
