...
class GetTaskPayloadResult extends Result implements ClientResultInterface, ServerResultInterface
{
     ...
     */
    public function __construct(?array $_meta = null, ?array $additionalProperties = null)
    {
    ...
    {
        return new self(self::asArrayOrNull($data['_meta'] ?? null), self::additionalFields($data, self::KNOWN_KEYS));
    }
    /**
