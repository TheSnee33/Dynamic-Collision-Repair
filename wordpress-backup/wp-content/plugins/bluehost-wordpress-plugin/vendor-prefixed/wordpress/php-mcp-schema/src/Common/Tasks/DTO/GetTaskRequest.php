...
class GetTaskRequest extends JSONRPCRequest implements ClientRequestInterface, ServerRequestInterface
{
     ...
     */
    public function __construct(string $jsonrpc, $id, GetTaskRequestParams $params)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $params = is_array($data['params']) ? GetTaskRequestParams::fromArray(self::asArray($data['params'])) : $data['params'];
