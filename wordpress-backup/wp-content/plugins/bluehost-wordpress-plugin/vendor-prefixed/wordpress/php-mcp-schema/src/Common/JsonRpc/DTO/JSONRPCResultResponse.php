...
class JSONRPCResultResponse extends AbstractDataTransferObject implements JSONRPCResponseInterface
{
     ...
     */
    public function __construct(string $jsonrpc, $id, Result $result)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $result = is_array($data['result']) ? Result::fromArray(self::asArray($data['result'])) : $data['result'];
        return new self($jsonrpc, $id, $result);
    }
    /**
