...
class ToolAnnotations extends AbstractDataTransferObject
{
    ...
    {
        return new self(self::asStringOrNull($data['title'] ?? null), self::asBoolOrNull($data['readOnlyHint'] ?? null), self::asBoolOrNull($data['destructiveHint'] ?? null), self::asBoolOrNull($data['idempotentHint'] ?? null), self::asBoolOrNull($data['openWorldHint'] ?? null));
    }
    /**
