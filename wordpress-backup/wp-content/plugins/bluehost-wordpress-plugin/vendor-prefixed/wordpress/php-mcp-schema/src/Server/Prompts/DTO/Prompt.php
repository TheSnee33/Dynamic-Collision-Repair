...
class Prompt extends BaseMetadata
{
     ...
     */
    public function __construct(string $name, ?string $title = null, ?string $description = null, ?array $arguments = null, ?array $_meta = null, ?array $icons = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $arguments = isset($data['arguments']) ? array_map(static fn($item) => is_array($item) ? PromptArgument::fromArray($item) : $item, self::asArray($data['arguments'])) : null;
        ...
        return new self(self::asString($data['name']), self::asStringOrNull($data['title'] ?? null), self::asStringOrNull($data['description'] ?? null), $arguments, self::asArrayOrNull($data['_meta'] ?? null), $icons);
    }
    /**
