...
class UnsubscribeRequest extends JSONRPCRequest implements ClientRequestInterface
{
     ...
     */
    public function __construct(string $jsonrpc, $id, UnsubscribeRequestParams $params)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $params = is_array($data['params']) ? UnsubscribeRequestParams::fromArray(self::asArray($data['params'])) : $data['params'];
