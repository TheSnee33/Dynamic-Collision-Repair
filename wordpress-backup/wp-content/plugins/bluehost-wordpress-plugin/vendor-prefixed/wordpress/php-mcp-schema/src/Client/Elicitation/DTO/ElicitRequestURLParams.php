...
class ElicitRequestURLParams extends TaskAugmentedRequestParams implements ElicitRequestParamsInterface
{
     ...
     */
    public function __construct(string $message, string $elicitationId, string $url, ?TaskMetadata $task = null, ?RequestParamsMeta $_meta = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(self::asString($data['message']), self::asString($data['elicitationId']), self::asString($data['url']), $task, $_meta);
    }
    /**
