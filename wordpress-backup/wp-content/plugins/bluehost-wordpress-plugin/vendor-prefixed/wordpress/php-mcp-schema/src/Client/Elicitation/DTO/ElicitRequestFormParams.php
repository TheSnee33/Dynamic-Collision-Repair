...
namespace Bluehost\Plugin\WP\McpSchema\Client\Elicitation\DTO;

use Bluehost\Plugin\WP\McpSchema\Client\Elicitation\Union\ElicitRequestParamsInterface;
...
class ElicitRequestFormParams extends TaskAugmentedRequestParams implements ElicitRequestParamsInterface
{
     ...
     */
    public function __construct(string $message, ElicitRequestFormParamsRequestedSchema $requestedSchema, ?TaskMetadata $task = null, ?RequestParamsMeta $_meta = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $requestedSchema = is_array($data['requestedSchema']) ? ElicitRequestFormParamsRequestedSchema::fromArray(self::asArray($data['requestedSchema'])) : $data['requestedSchema'];
        ...
        return new self(self::asString($data['message']), $requestedSchema, $task, $_meta);
    }
    /**
