...
class TitledSingleSelectEnumSchema extends AbstractDataTransferObject implements SingleSelectEnumSchemaInterface
{
     ...
     */
    public function __construct(array $oneOf, ?string $title = null, ?string $description = null, ?string $default = null)
    {
        $this->type = self::TYPE;
        $this->oneOf = $oneOf;
        $this->title = $title;
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self($oneOf, self::asStringOrNull($data['title'] ?? null), self::asStringOrNull($data['description'] ?? null), self::asStringOrNull($data['default'] ?? null));
    }
    /**
