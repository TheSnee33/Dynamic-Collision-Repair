...
class BlobResourceContents extends ResourceContents
{
     ...
     */
    public function __construct(string $uri, string $blob, ?string $mimeType = null, ?array $_meta = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(self::asString($data['uri']), self::asString($data['blob']), self::asStringOrNull($data['mimeType'] ?? null), self::asArrayOrNull($data['_meta'] ?? null));
    }
    /**
