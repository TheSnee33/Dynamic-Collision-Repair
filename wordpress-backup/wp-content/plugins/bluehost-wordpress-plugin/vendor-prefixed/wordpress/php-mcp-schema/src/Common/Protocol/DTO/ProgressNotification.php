...
class ProgressNotification extends JSONRPCNotification implements ClientNotificationInterface, ServerNotificationInterface
{
     ...
     */
    public function __construct(string $jsonrpc, ProgressNotificationParams $params)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $params = is_array($data['params']) ? ProgressNotificationParams::fromArray(self::asArray($data['params'])) : $data['params'];
