...
class StringSchema extends AbstractDataTransferObject implements PrimitiveSchemaDefinitionInterface
{
     ...
     */
    public function __construct(?string $title = null, ?string $description = null, ?int $minLength = null, ?int $maxLength = null, ?string $format = null, ?string $default = null)
    {
        $this->type = self::TYPE;
        $this->title = $title;
    ...
    public static function fromArray(array $data): self
    {
        ...
        $format = isset($data['format']) ? self::asStringOrNull($data['format']) : null;
        return new self(self::asStringOrNull($data['title'] ?? null), self::asStringOrNull($data['description'] ?? null), self::asIntOrNull($data['minLength'] ?? null), self::asIntOrNull($data['maxLength'] ?? null), $format, self::asStringOrNull($data['default'] ?? null));
    }
    /**
