...
class ToolOutputSchema extends AbstractDataTransferObject
{
     ...
     */
    public function __construct(?string $schema = null, ?array $properties = null, ?array $required = null, ?array $additionalProperties = null)
    {
        $this->type = self::TYPE;
        $this->schema = $schema;
    ...
    {
        return new self(self::asStringOrNull($data['$schema'] ?? null), self::asObjectMapOrNull($data['properties'] ?? null), self::asStringArrayOrNull($data['required'] ?? null), self::additionalFields($data, self::KNOWN_KEYS));
    }
    /**
    ...
    public function toArray(): array
    {
        ...
        $result['properties'] = !empty($this->properties) ? $this->properties : new \stdClass();
