...
class SetLevelRequest extends JSONRPCRequest implements ClientRequestInterface
{
     ...
     */
    public function __construct(string $jsonrpc, $id, SetLevelRequestParams $params)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $params = is_array($data['params']) ? SetLevelRequestParams::fromArray(self::asArray($data['params'])) : $data['params'];
