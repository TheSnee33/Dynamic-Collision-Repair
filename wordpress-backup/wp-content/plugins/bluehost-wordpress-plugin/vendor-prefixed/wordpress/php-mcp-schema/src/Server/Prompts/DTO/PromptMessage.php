...
class PromptMessage extends AbstractDataTransferObject
{
     ...
     */
    public function __construct(string $role, ContentBlockInterface $content)
    {
        $this->role = $role;
    ...
    public static function fromArray(array $data): self
    {
        ...
        $content = is_array($data['content']) ? ContentBlockFactory::fromArray(self::asArray($data['content'])) : $data['content'];
