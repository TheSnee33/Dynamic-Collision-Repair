...
class RequestParamsMeta extends AbstractDataTransferObject
{
     ...
     */
    public function __construct($progressToken = null, ?array $additionalProperties = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $progressToken = isset($data['progressToken']) ? self::asStringOrNumberOrNull($data['progressToken']) : null;
        return new self($progressToken, self::additionalFields($data, self::KNOWN_KEYS));
    }
    /**
