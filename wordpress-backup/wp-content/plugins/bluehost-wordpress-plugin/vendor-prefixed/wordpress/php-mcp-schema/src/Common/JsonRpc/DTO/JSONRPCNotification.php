...
class JSONRPCNotification extends Notification implements JSONRPCMessageInterface
{
     ...
     */
    public function __construct(string $method, string $jsonrpc, ?array $params = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(self::asString($data['method']), $jsonrpc, self::asArrayOrNull($data['params'] ?? null));
    }
    /**
