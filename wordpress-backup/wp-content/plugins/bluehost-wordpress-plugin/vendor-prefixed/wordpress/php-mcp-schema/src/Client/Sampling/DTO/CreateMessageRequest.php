...
class CreateMessageRequest extends JSONRPCRequest implements ServerRequestInterface
{
     ...
     */
    public function __construct(string $jsonrpc, $id, CreateMessageRequestParams $params)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $params = is_array($data['params']) ? CreateMessageRequestParams::fromArray(self::asArray($data['params'])) : $data['params'];
