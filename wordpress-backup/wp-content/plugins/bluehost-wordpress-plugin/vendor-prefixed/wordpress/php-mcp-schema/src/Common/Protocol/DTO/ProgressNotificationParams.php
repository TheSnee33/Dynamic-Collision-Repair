...
class ProgressNotificationParams extends NotificationParams
{
     ...
     */
    public function __construct($progressToken, float $progress, ?array $_meta = null, ?int $total = null, ?string $message = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self($progressToken, self::asFloat($data['progress']), self::asArrayOrNull($data['_meta'] ?? null), self::asIntOrNull($data['total'] ?? null), self::asStringOrNull($data['message'] ?? null));
    }
    /**
