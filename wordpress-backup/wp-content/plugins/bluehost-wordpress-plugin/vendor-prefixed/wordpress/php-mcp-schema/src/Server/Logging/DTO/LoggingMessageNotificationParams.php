...
class LoggingMessageNotificationParams extends NotificationParams
{
     ...
     */
    public function __construct(string $level, $data, ?array $_meta = null, ?string $logger = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self($level, $data['data'], self::asArrayOrNull($data['_meta'] ?? null), self::asStringOrNull($data['logger'] ?? null));
    }
    /**
