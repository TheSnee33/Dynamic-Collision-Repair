...
class PaginatedRequest extends JSONRPCRequest
{
     ...
     */
    public function __construct(string $jsonrpc, $id, string $method, ?PaginatedRequestParams $params = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self($jsonrpc, $id, self::asString($data['method']), $params);
    }
    /**
