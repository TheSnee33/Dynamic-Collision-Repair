...
use Bluehost\Plugin\WP\McpSchema\Common\Protocol\DTO\PaginatedRequest;
use Bluehost\Plugin\WP\McpSchema\Common\Protocol\DTO\PaginatedRequestParams;
...
class ListTasksRequest extends PaginatedRequest implements ClientRequestInterface, ServerRequestInterface
{
     ...
     */
    public function __construct(string $jsonrpc, $id, ?PaginatedRequestParams $params = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        $params = isset($data['params']) ? is_array($data['params']) ? PaginatedRequestParams::fromArray(self::asArray($data['params'])) : $data['params'] : null;
