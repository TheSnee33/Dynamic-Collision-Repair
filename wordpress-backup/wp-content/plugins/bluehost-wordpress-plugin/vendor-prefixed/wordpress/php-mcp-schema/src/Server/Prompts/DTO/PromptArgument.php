...
class PromptArgument extends BaseMetadata
{
     ...
     */
    public function __construct(string $name, ?string $title = null, ?string $description = null, ?bool $required = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(self::asString($data['name']), self::asStringOrNull($data['title'] ?? null), self::asStringOrNull($data['description'] ?? null), self::asBoolOrNull($data['required'] ?? null));
    }
    /**
