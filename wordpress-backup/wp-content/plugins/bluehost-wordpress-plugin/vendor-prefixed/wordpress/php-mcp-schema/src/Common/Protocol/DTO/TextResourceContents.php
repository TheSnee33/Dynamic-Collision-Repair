...
use Bluehost\Plugin\WP\McpSchema\Server\Resources\DTO\ResourceContents;
/**
 * @since 2024-11-05
...
class TextResourceContents extends ResourceContents
{
     ...
     */
    public function __construct(string $uri, string $text, ?string $mimeType = null, ?array $_meta = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(self::asString($data['uri']), self::asString($data['text']), self::asStringOrNull($data['mimeType'] ?? null), self::asArrayOrNull($data['_meta'] ?? null));
    }
    /**
