...
use Bluehost\Plugin\WP\McpSchema\Common\Protocol\DTO\InitializeResult;
...
class InitializeHandler
{
    ...
    public function handle(string $client_protocol_version): InitializeResult
    {
        ...
        $server_info = Implementation::fromArray(array('name' => $this->mcp->get_server_name(), 'version' => $this->mcp->get_server_version()));
        ...
        $capabilities = ServerCapabilities::fromArray(array('prompts' => array('listChanged' => \false), 'resources' => array('subscribe' => \false, 'listChanged' => \false), 'tools' => array('listChanged' => \false)));
        $result = InitializeResult::fromArray(array('protocolVersion' => $negotiated_version, 'capabilities' => $capabilities, 'serverInfo' => $server_info, 'instructions' => $this->mcp->get_server_description()));
        /**
