...
final class SessionManager
{
    ...
    public static function create_session(int $user_id, array $params = array())
    {
        ...
        $now = time();
        $sessions[$session_id] = array('created_at' => $now, 'last_activity' => $now, 'client_params' => $params);
        // Save sessions
    ...
    public static function get_all_user_sessions(int $user_id): array
    {
        ...
        $sessions = get_user_meta($user_id, self::SESSION_META_KEY, \true);
    ...
    private static function get_config(): array
    {
        ...
        return array('max_sessions' => $max_sessions, 'inactivity_timeout' => $inactivity_timeout, 'activity_update_interval' => max(0, $activity_update_interval));
    }
    /**
