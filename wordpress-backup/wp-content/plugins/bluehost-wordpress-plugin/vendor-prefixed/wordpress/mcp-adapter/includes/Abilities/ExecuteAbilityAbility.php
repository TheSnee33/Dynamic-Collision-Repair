...
final class ExecuteAbilityAbility
{
    ...
    public static function execute($input = array()): array
    {
        ...
        if (empty($ability_name)) {
            return array('success' => \false, 'error' => 'Ability name is required');
        }
        ...
        try {
            ...
            return array('success' => \true, 'data' => $result);
        } catch (\Throwable $e) {
