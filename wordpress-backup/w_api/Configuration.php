...
class Configuration
{
	const RESELLER_REQUEST_SECRET = '61c44067a57fd8197b5637284c974d81b37dad1da4a4f2f9a7ed8fe88a7a8756';
	const ERROR_REPORTING_LEVEL = '0';
	const DEPLOYED_HOSTNAME = 'dynamiccollisionprovo.com';
	const CLOUD_HOSTNAME = 'pages.weeblycloud.com';
	const DEPLOYED_HOSTNAME_HEADER = 'X-W-Cloud-Host';
	const BUILDDATE = '1715392196';
